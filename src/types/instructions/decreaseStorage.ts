...
export interface DecreaseStorageArgs {
  removeStorage: BN
  storageUsed: BN
}

export interface DecreaseStorageAccounts {
 ...
 */
export function decreaseStorage(
  args: DecreaseStorageArgs,
  accounts: DecreaseStorageAccounts
) {
  ...
  const identifier = Buffer.from([67, 13, 65, 65, 109, 230, 42, 138])
